...
@Component({
  ...
  styleUrls: ['./alianzas.component.html'],
})
export class AlianzasComponent implements OnInit, OnDestroy, AfterViewInit {
  paises: IPais[] = [];
